$(document).ready(function () {
    ...
    if ($("#checkoutForm").length && typeof checkLoginStatusAndLoadCheckout === "function") {
    ...
    if ($("#changePasswordForm").length && typeof initPasswordChange === "function") {
      initPasswordChange();
    }
    ...
    // Admin-Seiten 
    if ($("#adminProductsTable").length && typeof loadAdminProducts === "function") {
      loadAdminProducts();
    }
  
    if ($("#adminCustomersTable").length && typeof loadAdminCustomers === "function") {
      loadAdminCustomers();
    }
  
    if ($("#adminCouponsTable").length && typeof loadAdminCoupons === "function") {
      loadAdminCoupons();
    }
